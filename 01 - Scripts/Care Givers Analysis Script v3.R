...
# Set the directory:
setwd("C:/Users/Ben SMITH/Documents/Bangladesh/REACH Projects/Projects/Education Sector Assessment/")

# Either create the cleaned data:
# source("Scripts/Care Givers Cleaning Script v3.R") # This could do with being updated to output CSVs instead of xlxs as loading in data as an xlsx seems to crash the butteR functions. Below, the data has been coppied into csvs manually from the xlsx files.

# Or load it in directly:
hh <- read.csv(
  file = "03 - Outputs/02_clean_data/2020_12_15_hh_cleaned_data_with_consent.csv",
  na.strings = c(""," ","NA","N/A"),
  stringsAsFactors = FALSE)

indv = read.csv(
  file = "03 - Outputs/03_composite_indicators_with_data/Individual data - cleaned data with composite indicators - 2020_12_15.csv",
  na.strings = c(""," ","NA","N/A"),
  stringsAsFactors = FALSE)

# Read in the Data Analysis Plan:
DAP <- read.xlsx(xlsxFile = "04 - Other/CAREGIVER-SURVEY_DA instructions_v3.xlsx",
